...
void Ghost::draw(bool i_flash, sf::RenderWindow &i_window)
{
	...
	{
		// Red color
		texture.loadFromFile("Resources/Images/chi" + std::to_string(CELL_SIZE) + ".png");
		break;
	}
	case 1:
	{
		// Pink color
		texture.loadFromFile("Resources/Images/ann" + std::to_string(CELL_SIZE) + ".png");
		break;
	}
	case 2:
	{
		// Cyan color (I still don't understand why they called it blue)
		texture.loadFromFile("Resources/Images/que" + std::to_string(CELL_SIZE) + ".png");
		break;
	}
	case 3:
	{
		// Orange color
		texture.loadFromFile("Resources/Images/hua" + std::to_string(CELL_SIZE) + ".png");
	}
	}
