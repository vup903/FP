...
Ghost::Ghost(unsigned char i_id): id(i_id)
{
    switch (id)
    {
        ...
        {
            // Red color
            ghostTexture.loadFromFile("/Users/lbjessie/Desktop/大三上/程式設計/R/Resources/Images/chi.png");
            break;
        }
        case 1:
        {
            // Pink color
            ghostTexture.loadFromFile("/Users/lbjessie/Desktop/大三上/程式設計/R/Resources/Images/ann.png");
            break;
        }
        case 2:
        {
            // Cyan color (I still don't understand why they called it blue)
            ghostTexture.loadFromFile( "/Users/lbjessie/Desktop/大三上/程式設計/R/Resources/Images/que.png");
            break;
        }
        case 3:
        {
            // Orange color
            ghostTexture.loadFromFile("/Users/lbjessie/Desktop/大三上/程式設計/R/Resources/Images/hua.png");
        }
    }
